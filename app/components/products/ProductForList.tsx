...
export default function ProductForList({ params }: { params: IProduct }) {
    ...
    return (
        <Link
            className="flex flex-col p-4 cursor-pointer duration-300 border border-stone-100 dark:border-stone-950 dark:bg-stone-900 hover:bg-stone-200 dark:hover:bg-stone-800"
            href={`/products/${id}`}
        >
